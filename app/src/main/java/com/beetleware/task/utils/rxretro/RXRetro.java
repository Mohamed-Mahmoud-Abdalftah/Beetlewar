        ...
        call
                ...
                .subscribe(new Subscriber<Response<ResponseBody>>() {
                    ...
                    public void onError(Throwable e) {
                        Log.d(TAG, "onError: ThrowableThrowableThrowable  "+e);
                        try {
                    ...
                    public void onNext(Response<ResponseBody> paramResponse) {
                        ...
                        Log.d(TAG, "RAW RESPONSE - paramResponse " + paramResponse);
                        Log.d(TAG, "RAW RESPONSE - paramResponse toString " + paramResponse.toString());
                        Log.d(TAG, "RAW RESPONSE - paramResponse message  " + paramResponse.message());
                        Log.d(TAG, "RAW RESPONSE - paramResponse body  " + paramResponse.body());
